...
<style>
    .ffb-scope { box-sizing: border-box; color: #111827; font-family: "Inter", system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif; font-size: 14px; line-height: 1.5; width: 100%; max-width: 42rem; margin: 0 auto; -webkit-font-smoothing: antialiased; }
    .ffb-scope *, .ffb-scope *::before, .ffb-scope *::after { box-sizing: inherit; }

    .ffb-scope .ffb-card { background: #ffffff; border-radius: 0.5rem; padding: 2rem 1rem; }
    ...
    .ffb-scope .ffb-input { display: block; width: 100%; padding: 0.625rem 0.75rem; font-size: 0.875rem; font-family: inherit; line-height: 1.25; color: #111827; background-color: #f9fafb; border: 1px solid #d1d5db; border-radius: 0.5rem; appearance: none; transition: border-color 120ms ease, box-shadow 120ms ease, background-color 120ms ease; }
    .ffb-scope .ffb-input::placeholder { color: #9ca3af; }
    .ffb-scope .ffb-input:hover { border-color: #9ca3af; }
    .ffb-scope .ffb-input:focus { outline: none; border-color: #1c64f2; background-color: #ffffff; box-shadow: 0 0 0 3px rgba(164, 202, 254, 0.55); }
    ...
    .ffb-scope .ffb-checkbox { margin-top: 0.125rem; width: 1rem; height: 1rem; accent-color: #1c64f2; border-radius: 0.25rem; cursor: pointer; }
    .ffb-scope .ffb-checkbox-label { font-size: 0.875rem; line-height: 1.25; color: #111827; }

    .ffb-scope .ffb-submit { display: inline-flex; align-items: center; justify-content: center; width: 100%; padding: 0.625rem 1.25rem; font-size: 0.875rem; font-weight: 500; color: #ffffff; background: #1a56db; border: 1px solid transparent; border-radius: 0.5rem; cursor: pointer; transition: background 120ms ease, box-shadow 120ms ease; }
    .ffb-scope .ffb-submit:hover { background: #1e429f; }
    .ffb-scope .ffb-submit:focus { outline: none; box-shadow: 0 0 0 4px rgba(164, 202, 254, 0.6); }
    ...
    @media (min-width: 640px) {
        ...
        .ffb-scope .ffb-submit { width: auto; align-self: flex-start; grid-column: 1 / -1; justify-self: start; }
    }
    ...
    .ffb-scope .ffb-alert { padding: 1rem; border-radius: 0.5rem; margin-bottom: 1rem; font-size: 0.875rem; line-height: 1.4; }
